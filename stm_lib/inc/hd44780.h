...
//-------------------------------
#define LCD_WIRE_E          		      GPIOB // select your microcontroller gpio port
#define LCD_WIRE_RS          		      GPIOB // select your microcontroller gpio port
#define LCD_WIRE_D7          		      GPIOB // select your microcontroller gpio port
#define LCD_WIRE_D6          		      GPIOB// select your microcontroller gpio port
#define LCD_WIRE_D5          		      GPIOB // select your microcontroller gpio port
#define LCD_WIRE_D4          		      GPIOB // select your microcontroller gpio port
...
#define MCU_CLK_VALUE				  72
#define MCU_CLK						  ((MCU_CLK_VALUE - 1)/4)
#define MCU_WAIT_CYCLES				  100
//-------------------------------
